...
# PURPOSE: CODE CUSTOMIZATION 03 - Write a script that allows a user to pass several words as input.
# Determine how many lines within a given text contain (any combination) of the words input by the user.
