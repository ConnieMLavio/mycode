...
# CODE CUSTOMIZATION 04 - (DIFFICULT) - Write a script that allows a user to pass several words as input. 
# Determine how many sentences within a given text contain (any combination) of the words input by the user.
